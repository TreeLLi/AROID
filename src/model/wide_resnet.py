...
class WideResNet(nn.Module):
    ...
    def __init__(self, depth=28, out_dim=10, width=10, sub_block1=False, dropRate=0.0, bias_last=True, **kwargs):
        ...
        self.fc = nn.Linear(nChannels[3], out_dim, bias=bias_last)
