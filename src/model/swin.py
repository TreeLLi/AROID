...
def swin_small(input_dim, out_dim, patch_size, pretrained=False, **kwargs):
    return _create_swin_transformer('swin_small_patch4_window7_224',
...
def swin_tiny(input_dim, out_dim, patch_size, pretrained=False, **kwargs):
    return _create_swin_transformer('swin_tiny_patch4_window7_224',
                                    patch_size=patch_size,
                                    window_size=7,
                                    embed_dim=96,
                                    depths=(2, 2, 6, 2),
